...
export default function MyDecksScreen() {
  ...
  if (isLoading) {
    return (
      <View style={styles.loadingContainer} testID="my-decks-screen">
  ...
  if (loadError) {
    return (
      <View style={styles.errorContainer} testID="my-decks-screen">
  ...
  return (
    <View style={styles.container} testID="my-decks-screen">
      <DeckList
        decks={decks}
