...
const mockDecks: DeckWithCount[] = [
  { id: 1, name: "All", itemCount: 10, createdAt: new Date("2024-01-01"), studyDirection: "random" },
  { id: 2, name: "Verbs", itemCount: 5, createdAt: new Date("2024-01-02"), studyDirection: "random" },
];
